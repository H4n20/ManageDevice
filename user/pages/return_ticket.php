...
if ($user_id === null) {
    echo "Vui lòng đăng nhập để xem các phiếu trả của bạn.";
    exit();
}

// Truy vấn chỉ những phiếu trả do người dùng hiện tại tạo ra
$sql = "SELECT * FROM return_records WHERE user_id = ?";
...
if ($result->num_rows > 0) {
    echo "<h2>Danh sách phiếu trả của bạn</h2>";
    echo "<table border='1'>
            <tr>
                <th>ID</th>
                <th>ID Thiết bị</th>
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td><a href='user.php?page=edit_return&return_id=" . htmlspecialchars($row["return_id"]) . "'>Sửa</a></td> <!-- Nút sửa -->
            </tr>";
    }
    echo "</table>";
} else {
    echo "Không có phiếu trả nào.";
}
